...
export default function LoginPage() {
  ...
  function goToSignup(event: React.MouseEvent<HTMLButtonElement>) {
  ...
  const formFields = {
    ...
    submitButton: loading ? 'Anmelden…' : 'Anmelden',
    textVariantButton: 'Noch kein Konto? Jetzt registrieren',
  };
